...
PP_PKL=/home/rth/jdekok/my-scratch/nnunetv2/nnUNet/nnUNet_results/Dataset${BASE_ID}_NeckTumour/nnUNetTrainer__nnUNetPlans__${CONFIG}/fold_${FOLD}/validation/postprocessing.pkl
CHK=checkpoint_best.pth

# ─── NEW: black-combo test sets ─────────────────────────────────────
COMB_ROOT=/home/rth/jdekok/my-scratch/nnunetv2/nnUNet/nnunet_black_combos
DATASETS=(741 742 743 744 745 746 747 748 751 752 753 754 755 756)

OUT_ROOT=/home/rth/jdekok/my-scratch/nnunetv2/nnUNet/predictions_black_trained_combos
EVAL_ROOT=/home/rth/jdekok/my-scratch/nnunetv2/nnUNet/evaluation_results_black_trained
...
echo "✅  all BLACK combinations finished using labelsT"
